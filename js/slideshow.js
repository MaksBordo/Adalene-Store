...
function shiftLeft() {
  ...
  switch (productAmountIteration) {
    case 0:
      ...
      slideshowItems[productAmountIteration].style.transform =
        "translateX(500%)";
    ...
    case 4:
      ...
      slideshowItems[productAmountIteration + 1].style.transform =
        "translateX(-500%)";
      break;
    case 5:
      slideshowItems[productAmountIteration].style.opacity = "0";
  ...
  if (productAmountIteration === 6) {
    productAmountIteration = 0;
  }
}
...
function shiftRight() {
  ...
  productAmountIteration--;
  if (productAmountIteration < 0) {
    productAmountIteration = 5;
  }
}
